    ...
    <aside className="lg:sticky lg:top-0 lg:h-screen lg:w-[420px] lg:flex-shrink-0">
      <div className="relative h-full px-6 py-12 lg:py-24 lg:px-12 flex flex-col">
        ...
        <div className="flex-1">
          ...
          {/* Title */}
          <h2 className="font-serif text-xl md:text-2xl text-gold leading-relaxed mb-6">
            ...
            <ul className="space-y-4">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sand/60 hover:text-gold transition-colors link-underline inline-block"
                  >
                    {link.label}
                  </a>
                </li>
...
export function MobileNav() {
  return (
    <nav className="lg:hidden sticky top-0 z-50 bg-forest/95 backdrop-blur-sm border-b border-sand/10 px-6 py-4">
